...
|---|---|---|---|---|---|---|---|
| C1 | GitHub Bug Bounty — owned GitHub accounts/repos/orgs | Pending active setup; program explicitly allowed by assignment | Access-control / OAuth / API permission boundary candidate | TBD | Scope notes created; no active testing yet | Keep | Start with two owned accounts only; many easy items are ineligible. |
