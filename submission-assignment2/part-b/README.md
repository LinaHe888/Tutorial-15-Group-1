...
Part B focuses on one highest-impact valid in-the-wild finding.

Expected submission path targets:
...
- `presentation/part-b-presentation-outline.md`: five-minute presentation structure and Q&A prep.
